...
<template>
  <section class="pt-36 pb-40 bg-site-beige relative overflow-hidden">
    <div class="container relative z-10">
      <div class="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24 text-center lg:text-left">
        ...
        <div class="lg:w-1/2">
          <div class="reveal reveal-delay-1 rounded-sm overflow-hidden shadow-2xl transform hover:scale-105 transition-transform duration-500">
            <img src="https://cms.adocaoespiritualrio.org.br/uploads/papa_joao_paulo_II_cc80df17b9.jpg" alt="Histórias Inspiradoras" class="w-full h-auto object-cover aspect-[4/3]" />
          </div>
        </div>
